 ...
 * POC agents (Nora, Ava, Kiran) fill these shells in Sprint 2–3. This keeps the
    ...
    <div className="mx-auto max-w-3xl">
      <div className="rounded-2xl border border-line bg-surface p-8">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="inline-flex items-center rounded-full bg-band px-2.5 py-0.5 text-xs font-medium text-ink-2">
            {sprint}
          </span>
        </div>
        ...
        <div className="mt-6 rounded-xl border border-dashed border-line-2 bg-band/60 px-4 py-6 text-center">

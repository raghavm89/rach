...
export const metadata: Metadata = {
  title: "Features",
  description:
    "Explore every feature of the RachBase platform. Managed PostgreSQL, authentication, auto-generated APIs, AI agent templates, sandbox testing, one-click deploy, and more.",
};

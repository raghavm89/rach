 ...
 *
 * These were duplicated verbatim across login/page.tsx and signup/page.tsx,
 * including the inline SVG paths and a `NEXT_PUBLIC_API_URL` fallback that
 * pointed at the frontend's own port.
 */
...
const baseCls =
  ...
  'bg-white px-4 py-2.5 text-sm font-medium text-text-primary transition-colors hover:bg-bg-secondary ' +
  'focus:outline-none focus:ring-2 focus:ring-primary-blue/40';
...
export function OAuthButtons() {
  return (
    <div className="flex flex-col gap-2.5">
      <a href={`${BACKEND_URL}/api/auth/google`} className={baseCls}>
        <GoogleIcon />
        Continue with Google
      </a>
      <a href={`${BACKEND_URL}/api/auth/github`} className={baseCls}>
        <GitHubIcon />
